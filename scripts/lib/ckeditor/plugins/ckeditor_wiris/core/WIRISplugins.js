...
com.wiris.plugin.viewer.EditorViewer = $hxClasses["com.wiris.plugin.viewer.EditorViewer"] = function() {
	this.javaServicePath = "/pluginwiris_engine";
...
com.wiris.plugin.viewer.EditorViewer.prototype = {
	...
	,callCreateImage: function(mml,img) {
		...
		if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "EditorViewer.hx", lineNumber : 307, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "callCreateImage"});
		if(data.length < 2000) {
			if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace("GET:" + data,{ fileName : "EditorViewer.hx", lineNumber : 310, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "callCreateImage"});
			con.open("GET",url + "?" + data,false);
			con.send(null);
		} else {
			if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace("POST:" + data,{ fileName : "EditorViewer.hx", lineNumber : 314, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "callCreateImage"});
		...
		if(i >= 0) {
			...
			if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace(h.get("formula"),{ fileName : "EditorViewer.hx", lineNumber : 324, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "callCreateImage"});
		...
		if(height > 0) {
			if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace(height - baseline,{ fileName : "EditorViewer.hx", lineNumber : 335, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "callCreateImage"});
	...
	,processMathML: function(mml,container) {
		if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace(mml,{ fileName : "EditorViewer.hx", lineNumber : 269, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "processMathML"});
		...
		if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace(img.src,{ fileName : "EditorViewer.hx", lineNumber : 277, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "processMathML"});
	}
	...
	,replaceNodes: function(mathNodes,n) {
		...
		if(browser.getBrowser() == "Explorer" && (browser.getVersion() == "6" || browser.getVersion() == "7") && navigator.appVersion.indexOf("Trident") == -1) {
			if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace("Is ie7",{ fileName : "EditorViewer.hx", lineNumber : 168, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "replaceNodes"});
	...
	,doLoad: function() {
		if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace("doLoad",{ fileName : "EditorViewer.hx", lineNumber : 63, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "doLoad"});
		...
		while(_g1 < _g) {
			...
			if(j >= 0) {
				...
				if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace(this.baseURL,{ fileName : "EditorViewer.hx", lineNumber : 82, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "doLoad"});
			}
		}
		...
		if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace("Tech:" + this.tech,{ fileName : "EditorViewer.hx", lineNumber : 104, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "doLoad"});
		...
		if(com.wiris.plugin.viewer.EditorViewer.DEBUG) haxe.Log.trace("Language:" + this.lang,{ fileName : "EditorViewer.hx", lineNumber : 128, className : "com.wiris.plugin.viewer.EditorViewer", methodName : "doLoad"});
	}
	,tryReady: function() {
		var done;
		done = false;
